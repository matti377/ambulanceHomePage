import { loadCIS } from "./loadCIS";
import { loadRescuePoints } from "./loadRescuePoints";

const LUXEMBOURG_CENTER: L.LatLngExpression = [49.8153, 6.1296];
...
function formatRescuePointId(value: string): string {
...
function setupRescuePointSearch(map: L.Map, rescueMarkers: Map<string, L.Marker>): void {
...
function setupUserLocation(map: L.Map, userLayer: L.LayerGroup): void {
...
export async function initMap(elementId = "luxembourg-map"): Promise<L.Map> {
